...
from .common import pack_video_audio_rows
...
class MiniMaxH3DiffusionNFTPipeline(MiniMaxH3Pipeline):
    ...
    def _build_train_timesteps(capture: dict[str, Any]) -> torch.Tensor:
        ...
        # Drop the trailing sigma=0 endpoint; scale [0, 1] sigmas to [0, 1000] timesteps.
        # TODO(gpu-bringup): confirm this is the desired NFT timestep pool for the
        # dual-schedule model (video schedule chosen as the shared reference).
