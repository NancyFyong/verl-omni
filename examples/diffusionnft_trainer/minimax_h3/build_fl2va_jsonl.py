...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--image_dir", type=Path, required=True,
                        help="Directory containing {index:06d}.jpg images.")
    parser.add_argument("--output_dir", type=Path, required=True,
                        help="Where train.jsonl / test.jsonl are written; image "
                             "paths in the JSONL are relative to this directory.")
    parser.add_argument("--image_prefix", type=str, default="images",
                        help="Path prefix stored in the JSONL, relative to output_dir.")
