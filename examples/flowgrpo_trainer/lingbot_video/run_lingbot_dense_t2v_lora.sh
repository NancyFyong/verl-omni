...
python3 -m verl_omni.trainer.main_diffusion \
    ...
    actor_rollout_ref.model.lora_dtype=${LORA_DTYPE:-bf16} \
    ...
    actor_rollout_ref.actor.fsdp_config.model_dtype=${MODEL_DTYPE:-fp32} \
    ...
    actor_rollout_ref.rollout.agent.num_workers=$((${NUM_GPUS_ACTOR_ROLLOUT_REWARD:-8} / ${ROLLOUT_TP:-1})) \
    ...
    trainer.validation_data_max_samples=${VALIDATION_DATA_MAX_SAMPLES:-32} \
