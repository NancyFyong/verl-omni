...
python3 -m verl_omni.trainer.main_diffusion \
    ...
    actor_rollout_ref.model.transformer_subfolder=transformer_full \
    ...
    actor_rollout_ref.rollout.val_kwargs.pipeline.height=544 \
    actor_rollout_ref.rollout.val_kwargs.pipeline.width=960 \
    ...
    actor_rollout_ref.rollout.val_kwargs.pipeline.guidance_scale=3.0 \
    ...
    trainer.experiment_name=ltx2_5_t2av_lora \
