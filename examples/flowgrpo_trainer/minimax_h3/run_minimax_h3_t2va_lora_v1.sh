#!/usr/bin/env bash
# MiniMax H3 T2VA LoRA FlowGRPO (V1 trainer: TransferQueue + ReplayBuffer + sync mode).
#
# This is the V1 sync counterpart of run_minimax_h3_t2va_lora.sh. It uses
...
python3 -m verl_omni.trainer.main_diffusion_v1 \
    ...
    trainer.experiment_name=minimax_h3_t2va_lora_v1_gpu \
