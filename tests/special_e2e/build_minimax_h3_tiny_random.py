...
"""Build a self-contained tiny random MiniMax-H3 checkpoint.

The checkpoint is suitable for T2VA, image-conditioned FL2VA, and
reference-conditioned Ref2VA GPU smoke runs. It never reads, copies, or
symlinks a real MiniMax-H3 checkpoint.
